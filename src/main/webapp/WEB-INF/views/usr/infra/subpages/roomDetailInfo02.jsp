				...
				<div class="col-lg-12" id="single_tour_desc">
					...
					<div id="Img_carousel" class="slider-pro">
						<div class="sp-slides">
							...
							<div class="sp-slide">
								<img alt="Image" class="sp-image" src="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg" data-src="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg" data-small="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg" data-medium="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg" data-large="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg" data-retina="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg">
							</div>
						</div>
						<div class="sp-thumbnails">
							...
							<img alt="Image" class="sp-thumbnail" src="/resources/assets/img/accommodation/pension/gyunggido/01/01-2.jpg">
						</div>
					</div>

				...
				<aside class="col-lg-3">
					...
					<div class="box_style_cat">
						<ul id="cat_nav">
							...
							<li><a href="#" id="active"><i class="icon_set_1_icon-3"></i>펜션 <span>(...)</span></a>
							</li>
					...
					<div class="strip_hotel_seoul wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="/roomDetailInfo02"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/01/01.jpg"
										alt="Image">
							...
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="single_tour.html"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/02/02.jpg"
										alt="Image">
										<div class="short_info">
											<i class="icon_set_1_icon-51"></i>
										</div> </a>
					...
					<div class="strip_hotel_seoul wow fadeIn" data-wow-delay="0.3s">
						<div class="row">
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="single_tour.html"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/03/03.jpg"
										alt="Image">
										<div class="short_info">
											<i class="icon_set_1_icon-51"></i>
										</div> </a>
					...
					<div class="strip_hotel_seoul wow fadeIn" data-wow-delay="0.4s">
						<div class="row">
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="single_tour.html"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/04/04.jpg"
										alt="Image">
										<div class="short_info">
											<i class="icon_set_1_icon-51"></i>
										</div> </a>
					...
					<div class="strip_hotel_seoul wow fadeIn" data-wow-delay="0.5s">
						<div class="row">
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="single_tour.html"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/05/05.jpg"
										alt="Image">
										<div class="short_info">
											<i class="icon_set_1_icon-51"></i>
										</div> </a>
					...
					<div class="strip_hotel_seoul wow fadeIn" data-wow-delay="0.7s">
						<div class="row">
							<div class="col-lg-4 col-md-4 position-relative">
								...
								<div class="img_list">
									<a href="single_tour.html"><img
										src="/resources/assets/img/accommodation/pension/gyunggido/06/06.jpg"
										alt="Image">
										<div class="short_info">
											<i class="icon_set_1_icon-51"></i>
										</div> </a>

			  ...
			  <form name="form" method="post">
			  	<div class="d-flex flex-wrap justify-content-around">
	                ...
	                <div class=" col-5 mb-3">
                    	...
                    	<input type="text" class="form-control" name="info" id="info" value="<c:out value="${list.info }"></c:out>">
	                </div>
	                <div class=" col-5 mb-3">
	                  	<label for="iClass" class=" col-form-label">iClass</label>
                    	<input type="text" class="form-control" name="iClass" id="iClass" value="<c:out value="${list.iClass }"></c:out>">
	                </div>
	                <div class=" col-5 mb-3">

        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
			  ...
			  <form autocomplete="off" action="feedbackXdmList" method="post" name="formList">
					...
					<div class="d-flex mb-3 align-items-center">
						...
						<div class="col-2 text-start ms-3 me-3">
								<select class="form-control form-control-sm p-2" name="defaultNy" id="defaultNy">
									...
									<option value="1" <c:if test="${vo.defaultNy eq '1'}">selected</c:if>>N</option>
								</select>
						</div>
						<div class="col-2 text-start ms-3 me-3">
			...
			<c:if test="${vo.endPage ne vo.totalPages}">                
				...
				<div class="d-flex px-4 pb-5">
					...
					<div class="col text-end">
						...
						<button type="button" class="btn btn-primary btn-sm" id="plus" onclick = "location.href = '/feedbackXdmForm'">+</button>
					</div>
				</div>
          </div>

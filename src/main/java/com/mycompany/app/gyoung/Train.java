package com.mycompany.app.gyoung;
	...
	public class Train {
	    ...
	    public static void main(String[] args) throws IOException {
	        ...
	        urlBuilder.append("?" + URLEncoder.encode("serviceKey","UTF-8") + "=5dx59Iz3XSezPb2EagGTegCQHvL4o%2BP3Er41IuBsQ1nAcKAhlD3zq8Sp2Dh1clbSsNFATVFrRahABEc6qxLc5A%3D%3D"); /*Service Key*/
